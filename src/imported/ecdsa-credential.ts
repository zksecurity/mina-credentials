...
function EcdsaCredential(maxMessageLength: number) {
...
const EcdsaCred = await EcdsaCredential(50);
...
EcdsaEthereum.verify(String.from(message), signature, signer);
...
let vk = await EcdsaCred.compile();
